...
interface HeroVideoProps {
  animationStyle?: keyof typeof animationVariants; // Ensure the animationStyle is a key of animationVariants
  videoSrc: string;
  thumbnailSrc: string;
  thumbnailAlt?: string;
  className?: string;
...
export function HeroVideoDialog({
  animationStyle = "from-center", // Default to "from-center"
  videoSrc,
  thumbnailSrc,
  thumbnailAlt = "Video thumbnail",
  className,
  ...
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const selectedAnimation = animationVariants[animationStyle]; // This will now be properly typed
