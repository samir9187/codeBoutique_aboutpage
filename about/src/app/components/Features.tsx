...
// export function BentoDemo() {
//   return (
//     <div className="bg-white dark:bg-[rgba(2,8,26,1)] px-4 sm:px-6 lg:px-8 py-8">
//       <h2 className="text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 sm:mb-8 text-black dark:text-white">
//         Our Galactic Features
//       </h2> 

//       {/* Responsive Grid */}
//       <BentoGrid className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
//         {features.map((feature, idx) => (
//           <BentoCard key={idx} {...feature} />
//         ))}
//       </BentoGrid>
