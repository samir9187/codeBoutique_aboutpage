...
// //         <div
// //           onClick={handleClick}
// //           className={`mt-8 p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg transition-all duration-300 ease-in-out `}
// //         >
...
//           onClick={handleClick}
//           className={`mt-8 p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg transition-all duration-300 ease-in-out ${
//             isClicked ? "bg-opacity-75" : "bg-opacity-100"
//           }`}
//         >
//           <p className="mt-4 text-xl">
//             "To create innovative and efficient hiring solutions that enable
...
const Mission: React.FC = () => {
  return (
    <section className="py-16 bg-galaxy text-theme">
      <div className="max-w-screen-lg mx-auto text-center">
        <h2 className="text-3xl text-lightText font-bold">Our Mission</h2>
        <div className="mt-8 p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
          ...
          <p className="mt-6 text-lg text-purple-600 dark:text-purple-400 font-medium leading-relaxed tracking-wide text-center">
            "To create innovative and efficient hiring solutions that enable
            businesses to find top-tier talent using AI-driven insights. By
            leveraging cutting-edge technologies and data analytics, we aim to
            streamline the recruitment process, reduce hiring biases, and
