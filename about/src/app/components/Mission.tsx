      ...
      <div className="max-w-screen-lg mx-auto text-center">
        ...
        <div className="mt-8 p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
          <p className="mt-6 text-lg text-galaxy dark:text-purple-400 font-medium leading-relaxed tracking-wide text-center">
            &quot;To create innovative and efficient hiring solutions that
            enable businesses to find top-tier talent using AI-driven insights.
            By leveraging cutting-edge technologies and data analytics, we aim
            to streamline the recruitment process, reduce hiring biases, and
