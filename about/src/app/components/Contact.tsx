  ...
  return (
    <section className="py-12 relative z-20 bg-white dark:bg-[rgba(2,8,26,1)] text-galaxy dark:text-gray-300">
      <div className="py-12 relative z-20">
        <NeonGradientCard className="max-w-[90%] w-full m-auto rounded-xl ">
          <div className="flex flex-col space-y-1.5 p-6 sm:text-wrap leading-normal">
...
//       <div className="py-12 relative z-20">
//         {/* Card Container */}
//         <NeonGradientCard className="w-full max-w-[90%] sm:max-w-[850px] m-auto rounded-xl overflow-hidden">
//           {/* Content */}
...
//           <div className="relative w-full h-auto flex justify-center mt-6">
//             <CoolMode options={{ particleCount: 150 }}>
//               <div className="w-full max-w-[400px]">
//                 <Link
//                   href="mailto:joinus@galaxycorp.com"
//                   className="group relative inline-flex items-center justify-center p-0.5 px-4 py-2 w-full  text-center overflow-hidden font-medium text-teal-500 rounded-lg border-2 border-teal-500 hover:text-white hover:bg-teal-500"
//                 >
//                   <span className="absolute top-0 left-0 w-full h-full rounded-lg transition-all duration-300 group-hover:left-[-100%] group-hover:top-[-100%] ease  "></span>
//                   <span className="relative text-sm">Join Us!</span>
//                 </Link>
//               </div>
//             </CoolMode>
